...
Grazie per aver scelto di contribuire alla documentazione dei servizi di consulenza Adobe. Accogliamo con favore i contributi offerti dalla nostra comunità di lettori e dai colleghi che collaborano con Adobe.
...
Pur accogliendo con favore qualsiasi contributo volto a migliorare la documentazione AEM, richiediamo che i partecipanti rispettino, ove possibile, determinati standard e linee guida. Rivedi il [Linee guida per contribuire alla documentazione di ACS](guidelines.md) per ulteriori informazioni.
